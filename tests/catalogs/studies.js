...
/**
 * Test for /catalogs/studies
 */
Test('/catalogs/studies', function (t) {
...
Если имеется параметр enabled, то true - активные, false - неактивные
     ...
     * responses: 200, 400
     */
    t.test('test findStudies get operation', async function (t) {
     ...
     */
    t.test('test createStudy post operation', async function (t) {
