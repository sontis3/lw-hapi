...
/**
 * Test for /catalogs/studies/{studyId}/content/info
 */
Test('/catalogs/studies/{studyId}/content/info', function (t) {
     ...
     * responses: 200, 404
     */
    t.test('test getStudyContentInfo get operation', async function (t) {
