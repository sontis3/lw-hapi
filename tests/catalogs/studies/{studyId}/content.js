...
/**
 * Test for /catalogs/studies/{studyId}/content
 */
Test('/catalogs/studies/{studyId}/content', function (t) {
     ...
     * responses: 200, 400
     */
    t.test('test uploadStudyFile post operation', async function (t) {
     ...
     * responses: 200, 404
     */
    t.test('test getStudyContent get operation', async function (t) {
